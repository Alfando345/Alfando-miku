...
let d = new Date(new Date + 3600000)
    ...
    let dateIslamic = Intl.DateTimeFormat(locale + '-TN-u-ca-islamic', {
      ...
      year: 'numeric'
		...
		const reply = (teks) => {
            juna.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `${ucapanWaktu}\n${week} ${weton}, ${date}`,"body": `${botname}`,"previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/juna.png`),"sourceUrl": "http://wa.me/6285764175824"}}}, { quoted: m})
        }
...
𝙎𝙖𝙮𝙖 𝙖𝙙𝙖𝙡𝙖𝙝 ${namasbot}, 𝘽𝙤𝙩 𝙮𝙖𝙣𝙜 𝙗𝙚𝙧𝙛𝙪𝙣𝙜𝙨𝙞 𝙪𝙣𝙩𝙪𝙠 𝙢𝙚𝙢𝙗𝙪𝙖𝙩 𝙨𝙩𝙞𝙠𝙚𝙧 𝙙𝙖𝙣 𝙡𝙖𝙞𝙣 𝙡𝙖𝙞𝙣... 𝘼𝙥𝙖𝙠𝙖𝙝 𝙠𝙖𝙪 𝙗𝙪𝙩𝙪𝙝 𝙞𝙣𝙛𝙤 𝙙𝙖𝙧𝙞𝙠𝙪??? 𝙏𝙚𝙠𝙖𝙣 #𝙖𝙡𝙡𝙢𝙚𝙣𝙪 𝙪𝙣𝙩𝙪𝙠 𝙢𝙚𝙣𝙖𝙢𝙥𝙞𝙡𝙠𝙖𝙣 𝙨𝙚𝙢𝙪𝙖 𝙢𝙚𝙣𝙪, 𝘼𝙩𝙖𝙪 𝙩𝙚𝙠𝙖𝙣 𝙩𝙤𝙢𝙗𝙤𝙡 𝙙𝙞𝙗𝙖𝙬𝙖𝙝 𝙪𝙣𝙩𝙪𝙠 𝙢𝙚𝙣𝙚𝙢𝙥𝙞𝙡𝙠𝙖𝙣 𝙢𝙚𝙣𝙪...`
